...
var (
	...
	HW_CLOUDTABLE_REGION            = os.Getenv("HW_CLOUDTABLE_REGION")
...
func testAccPreCheckCloudTable(t *testing.T) {
	if HW_CLOUDTABLE_AVAILABILITY_ZONE == "" || HW_CLOUDTABLE_REGION == "" {
		t.Skip("HW_CLOUDTABLE_AVAILABILITY_ZONE,HW_CLOUDTABLE_REGION must be set for CloudTable tests")
	}
}
